...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='experiment_name', help=' ')
        ...
        self.parser.add_argument('--init', type=str, default='xavier', help='the way of initialize weights')
        self.parser.add_argument('--net_structure', type=str, default='DBNet', help='net_structure')
